...
public class HomePage {
	...
	private By descricoesProduto = By.cssSelector(".product-description a");
	...
	public String obterNomeProduto(int indice) {
		return driver.findElements(descricoesProduto).get(indice).getText();
		}
	...
	public ProdutoPage clicarProduto(int indice) {
		driver.findElements(descricoesProduto).get(indice).click();
